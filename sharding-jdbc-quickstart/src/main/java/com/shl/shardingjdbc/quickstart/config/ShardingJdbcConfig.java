package com.shl.shardingjdbc.quickstart.config;
 ...
 */
//@Configuration
//在Application中配置：@SpringBootApplication(exclude = org.apache.shardingsphere.shardingjdbc.spring.boot.SpringBootConfiguration.class) 使用sharding-jdbc的java配置的时候需要排除SpringBootConfiguration.class
public class ShardingJdbcConfig {
  ...
  DataSource getShardingDataSource() throws SQLException {
    ...
    return ShardingDataSourceFactory
        .createDataSource(createDataSourceMap(), shardingRuleConfig, properties);
  }
}
